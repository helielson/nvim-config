...
" Name:       pb.vim
" Version:    1.0
" Maintainer: https://github.com/helielson/jb.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/joshdick/onedark.vim/


" The background blue: #1d2830
...
let s:white = { "gui": "#afafaf", "cterm": "145", "cterm16" : "7" }
let s:dark_white = { "gui": "#808080", "cterm": "244", "cterm16" : "7" }
...
let s:comment_grey = { "gui": "#5C6670", "cterm": "236", "cterm16": "15" }
...
let s:visual_grey = { "gui": "#3E4451", "cterm": "238", "cterm16": "15" }
...
call s:h("String", { "fg": s:white }) " a string constant: "this is a string"
call s:h("Character", { "fg": s:green }) " a character constant: 'c', '\n'
call s:h("Number", { "fg": s:white }) " a number constant: 234, 0xff
call s:h("Boolean", { "fg": s:white }) " a boolean constant: TRUE, false
call s:h("Float", { "fg": s:white }) " a floating point constant: 2.3e10
call s:h("Identifier", { "fg": s:dark_white }) " any variable name
call s:h("Function", { "fg": s:dark_white }) " function name (also: methods for classes)
call s:h("Statement", { "fg": s:dark_white }) " any statement
call s:h("Conditional", { "fg": s:dark_white }) " if, then, else, endif, switch, etc.
call s:h("Label", { "fg": s:dark_white }) " case, default, etc.
call s:h("Operator", {}) " sizeof", "+", "*", etc.
call s:h("Keyword", { "fg": s:dark_white }) " any other keyword
call s:h("Exception", { "fg": s:purple }) " try, catch, throw
call s:h("PreProc", { "fg": s:yellow }) " generic Preprocessor
call s:h("Include", { "fg": s:dark_white }) " preprocessor #include
call s:h("Define", { "fg": s:purple }) " preprocessor #define
call s:h("Macro", {}) " same as Define
call s:h("PreCondit", {}) " preprocessor #if, #else, #endif, etc.
call s:h("Type", { "fg": s:dark_white }) " int, long, char, etc.
call s:h("StorageClass", {}) " static, register, volatile, etc.
call s:h("Structure", {}) " struct, union, enum, etc.
call s:h("Typedef", {}) " A typedef
call s:h("Special", { "fg": s:dark_white }) " any special symbol
...
call s:h("SpellCap", { "fg": s:dark_white }) " Word that should start with a capital. This will be combined with the highlighting used otherwise.
...
call s:h("javaScriptIdentifier", { "fg": s:dark_white })
call s:h("javaScriptNull", { "fg": s:dark_white })
call s:h("javaScriptNumber", { "fg": s:dark_white })
